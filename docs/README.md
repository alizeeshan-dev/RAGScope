# RAGScope documentation index

## Build and operate

- [Reproducibility and fixture workflow](REPRODUCIBILITY.md) — environment,
  corpus/benchmark preparation, pilot execution, exports, and verification commands.
...
- [Methodology](METHODOLOGY.md) — research questions, controls, metric definitions,
  missingness, cost, repetitions, and reproducibility requirements.
- [Threats to validity](THREATS_TO_VALIDITY.md) — internal, external, construct,
  conclusion, responsible-use, and security limitations.
